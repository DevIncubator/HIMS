...
INSERT INTO [dbo].[Task] ( [Name], [Description], [StartDate], [DeadlineDate]) VALUES
	(N'Разработать class A', N'Необходимо разработать class A', '2018-02-14', '2018-02-24'),
	(N'Разработать class B', N'Необходимо разработать class B', '2018-02-15', '2018-02-25'),
	(N'Разработать контроллер', N'Необходимо разработать контроллер для работы с пользователём', '2018-03-10', '2018-03-30'),
	(N'Разработать view', N'Необходимо разработать view для class A и class B', '2018-03-14', '2018-03-24'),
	(N'Тестирование приложения', N'Необходимо написать тесты для контроллера', '2018-03-16', '2018-03-26'),
	(N'Развернуть проект', N'Необходимо развернуть приложение на хосте', '2018-03-20', '2018-03-30')
...
INSERT INTO	[dbo].[TaskTrack] ([TrackDate], [TrackNote], [UserTaskId]) VALUES
	...
	('2018-03-11', N'Начала разрабатывать контроллер', 7),
	('2018-03-10', N'Приступил к разработке контроллера', 2),
	('2018-03-15', N'Верстаю вьюхи', 11),
	('2018-02-15', N'Начала разрабатывать Class A', 9),
