...
{
	/// <summary>Class which represents the entity 'VUserProgress'.</summary>
	[Serializable]
	[DataContract(IsReference=true)]
	public partial class VUserProgress : CommonEntityBase
	{
		...
		/// <summary>Initializes a new instance of the <see cref="VUserProgress"/> class.</summary>
		public VUserProgress() : base()
		{
			OnCreated();
		}
